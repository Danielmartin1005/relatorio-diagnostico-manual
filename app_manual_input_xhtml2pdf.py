...
if gerar:
    ...
    html_rendered = template.render(
        ...
        percentual_acertos=f"{percentual}%",
        nivel_geral=nivel,
        resumo_pedagogico=resumo.replace("\n", "<br>"),
        pontos_atencao=", ".join(habilidades_atencao) if habilidades_atencao else "Nenhuma",
        estrategias=" | ".join(set(habilidades_atencao)) if habilidades_atencao else "Acompanhar reforço conforme necessidade"
    )
