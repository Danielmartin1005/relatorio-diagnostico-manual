...
regua = pd.DataFrame([
    ...
    {"Série": "6º Ano", "Questão": "Q2", "Alternativa marcada": "B", "Nível de conhecimento do estudante": "Intermediário", "Possível causa do erro": "Confusão com ingredientes", "Estratégia de intervenção": "Explorar estrutura da receita", "Habilidades necessárias (BNCC)": "EF05LP18"},
    {"Série": "6º Ano", "Questão": "Q2", "Alternativa marcada": "C", "Nível de conhecimento do estudante": "Básico", "Possível causa do erro": "Repetição da alternativa anterior", "Estratégia de intervenção": "Corrigir a distinção entre partes da receita", "Habilidades necessárias (BNCC)": "EF05LP18"},
    {"Série": "6º Ano", "Questão": "Q2", "Alternativa marcada": "D", "Nível de conhecimento do estudante": "Muito básico / Inicial", "Possível causa do erro": "Não reconhece função do modo de preparo", "Estratégia de intervenção": "Atividades práticas com receitas", "Habilidades necessárias (BNCC)": "EF05LP18"},
